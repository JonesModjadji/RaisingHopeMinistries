...
if (isset($_POST['Save'])) {
  ...
  $sql = ("UPDATE service2 SET Name = '$Name',Surname = '$Surname',Contact = '$Contact',Attending = '$Attending' WHERE SeatID='" . $_GET["id"] . "'");
...
<title>Raising Hope Ministries Service 2</title>
...
<div class="services" id="services" style="margin-top:100px;">
  <center>
  <section class="submit" style="padding-top: 150px;">
  	<?php
  	 echo '<div><h3>Fill in :</h3>
 <br>
 <br>
';
$sql1 = ("SELECT * FROM service2 WHERE SeatID='" . $_GET["id"] . "'");
