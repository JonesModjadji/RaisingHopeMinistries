...
if (isset($_POST['Save'])) {
  ...
  $sql = ("UPDATE service3 SET Name = '$Name',Surname = '$Surname',Contact = '$Contact',Attending = '$Attending' WHERE SeatID='" . $_GET["id"] . "'");
...
<div class="services" id="services" style="margin-top:100px;">
 ...
 <br>
';
$sql1 = ("SELECT * FROM service3 WHERE SeatID='" . $_GET["id"] . "'");
